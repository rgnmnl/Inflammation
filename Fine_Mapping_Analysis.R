##############################################################################
## Title: Fine Mapping Analysis for IL6
## Reference: https://www.biorxiv.org/content/10.1101/2020.01.17.910497v1
## Author: Regina Manansala
## Date Created: 07-October-2019
## Date Modified: 09-October-2019
##############################################################################

library(data.table)
library(dplyr)

## Get result for rs6734238
min <- 113083453 - 250000
max <- 113083453 + 250000
encore_result <- fread("il6_encore_results.txt") %>% subset(., CHR == 'chr2' & POS %between% c(min,max))
